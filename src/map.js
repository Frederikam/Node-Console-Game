...
module.exports = {
	...
	startup: function(){
		...
		this.rooms["1:-1"] = new GenericRoom(1, -1, "There is not a tree here.");
		this.rooms["-1:0"] = new GenericRoom(-1, 0, "There is a house here.");
		...
		this.rooms["1:1"] = new GenericRoom(1, 1, "There is a beach here.");
	}
